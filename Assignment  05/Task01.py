...
print(f"R2 base(bmi+s5)  is :  {r2_test_base:2f}")
print(f"R2  +bp  is: {r2_test_bp:2f}")
print(f"R2 +bp + s4 is: {r2_test_bpS4:2f}")
print(f"RMSE base(bmi+s5) is:  {rmse_test_base:2f}")
print(f"RMSE +bp is: {rmse_test_bp:2f}")
print(f"RMSE +bp+s4 is: {rmse_test_bpS4:2f}")